...
namespace GraphUserAdmin.API.Extensions
{
    ...
    {
        public static IServiceCollection ConfigureSwagger(this IServiceCollection serviceCollection, AuthenticationConfiguration authenticationOptions)
        {
                    ...
                    Flows = new OpenApiOAuthFlows
                    {
                        Implicit = new OpenApiOAuthFlow
                        {
                            ...
                            Scopes = Constants.DelegatedPermissions.All.ToDictionary(p =>
                                $"{authenticationOptions.Audience}/{p}")
                        }
                    }
                });
    ...
    internal class OAuthSecurityRequirementOperationFilter(AppConfiguration appConfiguration) : IOperationFilter
    {
        private readonly string _appIdUri = appConfiguration.TenantConfig!.Audience!;
